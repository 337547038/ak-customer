...
import customer.service.DictService;
...
public class DictController {
    ...
    @PostMapping("get")
    public ResponseEntity<Dict> queryById(@RequestBody Map<String, Integer> query) {
        return ResponseEntity.ok(this.dictService.queryById(query.get("id")));
    }
