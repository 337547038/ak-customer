...
public class RoleController {
    ...
    public ResponseEntity<Map<String, Object>> queryByPage(@RequestBody Map<String, Object> pages) {
        return ResponseEntity.ok(this.roleService.queryByPage(pages));
    }
    ...
    @PostMapping("get")
    public ResponseEntity<Role> queryById(@RequestBody Map<String, Integer> query) {
        return ResponseEntity.ok(this.roleService.queryById(query.get("id")));
    }
    ...
    @PostMapping("save")
    public ResponseEntity<Integer> add(@RequestBody Role role) {
    ...
    @PostMapping("edit")
    public ResponseEntity<Integer> edit(@RequestBody Role role) {
    ...
    public ResponseEntity<Boolean> deleteById(@RequestBody Map<String, Object> ids) {
        ...
        return ResponseEntity.ok(this.roleService.deleteById(idList));
    }
    ...
    public ResponseEntity<List<String>> queryByIds(@RequestBody Map<String, Object> params) {
        Object ids = params.get("id");
        if (ids == null || ids == "") {
            return ResponseEntity.ok(new ArrayList<>());
        }
       return ResponseEntity.ok(this.roleService.queryByIds((String) ids));
    }
