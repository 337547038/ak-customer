...
public class CustomerController {
    ...
    @Parameters({
            ...
            @Parameter(name = "extend.columns", description = "返回指定扩展字段可选user,contact可联合查询用户名联系人表,diy可自返回字段"),
            @Parameter(name = "extend.diyColumns", description = "当extend.columns=diy时，自定字段"),
