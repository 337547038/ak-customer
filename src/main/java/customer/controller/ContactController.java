...
public class ContactController {
    ...
    public ResponseEntity<Map<String, Object>> queryByPage(@RequestBody Map<String, Object> pages) {
        return ResponseEntity.ok(this.contactService.queryByPage(pages));
    }
    ...
    @PostMapping("get")
    public ResponseEntity<Contact> queryById(@RequestBody Map<String, Integer> query) {
        return ResponseEntity.ok(this.contactService.queryById(query.get("id")));
    }
    ...
    @PostMapping("edit")
    public ResponseEntity<Integer> edit(@RequestBody Contact contact) {
        return ResponseEntity.ok(this.contactService.updateById(contact));
    }
    ...
    public ResponseEntity<Boolean> deleteById(@RequestBody Map<String,Object> ids) {
        ...
        return ResponseEntity.ok(this.contactService.deleteById(idList));
    }
