...
public class ContractController {
    ...
    @Parameters({
            ...
            @Parameter(name = "extend.search",description = "可选child查询下属"),
    })
    @PostMapping("list")
    public ResponseEntity<Map<String, Object>> queryByPage(@RequestBody Map<String, Object> pages) {
        return ResponseEntity.ok(this.contractService.queryByPage(pages));
    }
    ...
    @PostMapping("get")
    public ResponseEntity<Contract> queryById(@RequestBody Map<String, Integer> query) {
        return ResponseEntity.ok(this.contractService.queryById(query.get("id")));
    }
    ...
    @PostMapping("save")
    public ResponseEntity<Integer> add(@RequestBody Contract contract) {
    ...
    @PostMapping("edit")
    public ResponseEntity<Integer> edit(@RequestBody Contract contract) {
        return ResponseEntity.ok(this.contractService.updateById(contract));
    }
    ...
    public ResponseEntity<Boolean> deleteById(@RequestBody Map<String,Object> ids) {
        ...
        return ResponseEntity.ok(this.contractService.deleteById(idList));
    }
